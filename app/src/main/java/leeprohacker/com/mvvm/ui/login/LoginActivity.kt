...
import leeprohacker.com.mvvm.injection.ViewModelFactory
import leeprohacker.com.mvvm.ui.home.MainActivity
import leeprohacker.com.mvvm.utils.extension.hideKeyboard
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel.loadingVisibility.observe(this@LoginActivity, Observer {
            it?.let {
                if (it == View.VISIBLE){
                    this.hideKeyboard()
                }
